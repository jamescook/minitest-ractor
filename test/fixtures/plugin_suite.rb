...
# them: minitest first, then this gem, both before any test class exists. Minitest 6 does not
# auto-discover plugins, so requiring it by name is the whole opt-in — and it must still leave
# the suite alone until --ractor or MT_RACTOR says otherwise.
#
